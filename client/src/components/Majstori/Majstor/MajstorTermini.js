...
import RasporedMajstor from "../../Forma/RasporedMajstor";

const termini1 = [
  { trajanje: 60, vreme: 17 },
  { trajanje: 45, vreme: 18 },
];
const termini2 = [
  { trajanje: 45, vreme: 13 },
  { trajanje: 30, vreme: 19 },
];
...
const MajstorTermini = (props) => {
  ...
  const Day = (props) => {
    ...
    return (
      <Tab
        ...
        value={props.broj}
        label={nadjiDan((dan + props.broj) % 7) + " " + pomDatum.getDate()}
        tabIndex={props.broj}
  ...
  return (
    <Box sx={{ mt: 20, alignItems: "center", textAlign: "center" }}>
      <Box>
        <Box
          sx={{
            flexGrow: 1,
